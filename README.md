...
**Magnetostatic Stray Field solver for 2d thin films**: FFT enhanced stray field computation at a specified observation plane at height h, for a 2d magnetic thin film. The method is built using PyTorch to be fully differentiable and incorporates GPU optimization. 
